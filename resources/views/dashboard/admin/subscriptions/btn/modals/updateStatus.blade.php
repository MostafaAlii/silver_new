<div class="modal fade" id="updateStatus{{ $subscription->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('subscriptions.update-status', $subscription->id)}}" method="POST">
                    @csrf
                    <!-- Start Status Status -->

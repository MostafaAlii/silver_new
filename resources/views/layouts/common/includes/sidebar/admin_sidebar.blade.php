    ...
    <div class="side-menu-fixed">
        <div class="scrollbar side-menu-bg">
            <ul class="nav navbar-nav side-menu" id="sidebarnav">
                ...
                <li class="pl-4 mt-10 mb-10 font-medium text-muted menu-title">Subscription</li>
                <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#subscriptions_managment">
                        <div class="pull-left">
                            <i class="ti-palette"></i>
                    ...
                    <ul id="subscriptions_managment" class="collapse" data-parent="#sidebarnav">
                        <li><a href="{{route('subscriptions.index')}}">Subscription</a></li>
                    </ul>
                </li>

...
class SettingsController extends Controller {
    public function index() {
        return view('dashboard.admin.settings.index', ['title' => 'Main Settings','setting' => Settings::latest('created_at')]);
    }

    public function update(Request $request) {
        $settingData = $request->except(['_token']);
        $setting = Settings::updateOrCreate(['id' => Settings::latest()->first()->id, 'facebook' => fake()->url(),
            'instagram' => fake()->url(),
